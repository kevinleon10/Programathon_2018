...
@ManagedBean
@RequestScoped
public class AdminChildrenTableController implements Serializable {
    ...
    public AdminChildrenTableController() {
    ...
    public void queryChild(Children child) {
        ...
        try {
            FacesContext.getCurrentInstance().getExternalContext().redirect("/Programathon_2018/administrator/children-information.html");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
